...
def write_chapter3(doc, R, figures_dir, eq):
    ...
    body(doc,
         ...
         "replaces point-forecast comparison, and the software implementation.")
    body(doc,
...
def write_chapter4(doc, R, figures_dir, eq):
    ...
    body(doc,
         ...
         "known. Figure 6 shows the same information graphically, as 95 per "
    ...
    figure(doc, figures_dir / "Fig6_SkillVsLead.png",
           "Figure 6: Estimated AR/MA coefficients with 95 per cent "
    ...
    body(doc,
         ...
         "and shown in Figure 5. The Ljung–Box test examines whether linear "
    ...
    figure(doc, figures_dir / "Fig5_ResidualDiagnostics.png",
           "Figure 5: Residual distribution (left) and residual "
    ...
    body(doc,
         ...
         "Section 3.6. Figure 3 compares the 5th-to-95th-percentile band of "
    ...
    figure(doc, figures_dir / "Fig3_ForecastHydrograph.png",
           "Figure 3: Synthetic ensemble (5th-95th percentile band and "
    ...
    figure(doc, figures_dir / "Fig4_Scatter.png",
           "Figure 4: Property-based validation, historical statistic "
